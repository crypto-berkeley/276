...
These random variables don't have to be from the same distribution.
\end{definition}
...
$$SD(X_n, Y_n) = \frac{1}{2}\sum\limits_{v \in S}|\Pr[X_n = v] - \Pr[Y_n = v]|$$
...
Assume for the sake of contradiction that there exists a non-uniform PPT adversary $\ma$ that can distinguish $H_0$ from $H_l$.
