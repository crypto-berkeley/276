...
\declaretheorem[numberwithin=chapter,shaded={bgcolor=yellow}]{definition}
...
\input{macros}
%%
% Configure natbib for numeric citations
% Note: tufte-book loads natbib, so we need to configure it properly
%%
